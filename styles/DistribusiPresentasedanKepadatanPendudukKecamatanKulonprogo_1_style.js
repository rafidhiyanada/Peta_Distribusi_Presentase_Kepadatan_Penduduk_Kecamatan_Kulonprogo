...
var style_DistribusiPresentasedanKepadatanPendudukKecamatanKulonprogo_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Join_Kepadatan Penduduk (Jiwa/Km2)");
    ...
    if (value >= 397.000000 && value <= 501.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 501.200000 && value <= 785.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 785.000000 && value <= 873.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 873.000000 && value <= 979.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 979.000000 && value <= 1541.000000) {
            style = [ new ol.style.Style({
